        ...
        <div className="mb-16">
          ...
          <AnimatedDiv delay={0.8}>
            <div className="mt-8 flex justify-end">
              ...
              >
                <Card className="group border border-gray-200 dark:border-gray-700 hover:border-primary/60 bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-950/20 dark:to-indigo-900/20 hover:shadow-xl transition-all duration-500 cursor-pointer hover:-translate-y-1">
