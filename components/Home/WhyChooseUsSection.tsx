...
const defaultBenefits: Benefit[] = [
  {
    ...
    bgGradient: "from-primary/10 to-primary/20 dark:from-primary-950/20 dark:to-primary-950/20",
  ...
  },
  {
    ...
    gradient: "from-primary to-secondary",
    bgGradient: "from-secondary/10 to-secondary/20 dark:from-secondary-950/20 dark:to-secondary-950/20",
    iconColor: "text-secondary",
  },
  {
