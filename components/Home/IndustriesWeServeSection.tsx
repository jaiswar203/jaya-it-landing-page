              ...
              <Card className="group h-full shadow-lg hover:shadow-2xl transition-all duration-500 bg-white dark:bg-gray-900 hover:-translate-y-3 border border-gray-200/50 dark:border-gray-700/50 cursor-pointer">
                <CardHeader className="space-y-6">
                  <div className="flex items-center space-x-4">
                    <div
                      className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl ${industry.iconBg} text-white shadow-lg group-hover:scale-110 transition-all duration-500`}
                    >
                      {industry.icon}
                    </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid gap-4">
                      {industry.features.map((feature) => (
                        <div
                          key={feature}
                          className={`flex items-start space-x-4 p-4 rounded-xl bg-gradient-to-r ${
                            industry.colorClass.split(" ")[0]
                          } ${industry.colorClass.split(" ")[1]} ${
                            industry.colorClass.split(" ")[2]
                          } ${
                            industry.colorClass.split(" ")[3]
                          } border border-gray-200/50 dark:border-gray-700/50 transition-all duration-300 hover:scale-[1.02]`}
                        >
        ...
        <div className="text-center">
          <AnimatedDiv delay={0.8}>
            <Button
              asChild
              size="lg"
              className="bg-primary shadow-lg hover:shadow-xl transition-all duration-300 px-8 py-4 text-lg"
            >
