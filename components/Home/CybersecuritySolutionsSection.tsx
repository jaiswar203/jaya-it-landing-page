            ...
            <AnimatedDiv key={category.category} delay={categoryIndex * 0.2}>
              <div className="space-y-8">
                <div className="relative">
                  <div className={`w-full h-24 bg-gradient-to-r ${category.bgGradient} rounded-2xl relative overflow-hidden`}>
                    ...
                    <div className="relative h-full flex items-center px-8">
                      <div className="flex items-center gap-6">
                        <div className="flex items-center justify-center w-16 h-16 rounded-2xl bg-white dark:bg-gray-900 shadow-xl border border-white/20 dark:border-gray-700/20">
                          <div className={`${category.iconColor} [&>svg]:h-8 [&>svg]:w-8`}>
                            {category.icon}
                          </div>
                        </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {category.solutions.map((solution, index) => (
                    <AnimatedDiv key={solution.name} delay={categoryIndex * 0.2 + index * 0.1}>
                      <Card className={`group h-full border-0 shadow-lg hover:shadow-2xl transition-all duration-500 bg-gradient-to-br  hover:-translate-y-1 flex flex-col`}>
