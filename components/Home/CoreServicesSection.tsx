...
const defaultServices: ServiceHighlight[] = [
  {
    ...
    iconBg: "from-secondary/10 to-secondary/20 dark:from-secondary-950/20 dark:to-secondary-900/20",
  },
  {
    ...
    gradient: "text-secondary",
    iconBg: "from-primary/10 to-primary/20 dark:from-primary-950/20 dark:to-primary-900/20",
  },
  {
