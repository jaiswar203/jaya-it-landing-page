...
const defaultSolutions: Solution[] = [
  ...
  },
  {
    ...
    bgGradient: "from-pink-50 to-pink-100 dark:from-pink-950/20 dark:to-pink-900/20",
  ...
  },
  {
    ...
    bgGradient: "from-violet-50 to-violet-100 dark:from-violet-950/20 dark:to-violet-900/20",
    category: "Security Testing"
  },
  {
...
const getCategoryTheme = (category: string, index: number) => {
  const themes = [
    { 
      ...
      secondary: "from-blue-50 to-cyan-50 dark:from-blue-950/20 dark:to-cyan-950/20",
      accent: "text-blue-600 dark:text-blue-400"
    },
    { 
      primary: "from-purple-500 to-pink-500", 
      secondary: "from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20",
      accent: "text-purple-600 dark:text-purple-400"
    },
    { 
      primary: "from-green-500 to-emerald-500", 
      secondary: "from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20",
      accent: "text-green-600 dark:text-green-400"
    },
    { 
      primary: "from-orange-500 to-red-500", 
      secondary: "from-orange-50 to-red-50 dark:from-orange-950/20 dark:to-red-950/20",
      accent: "text-orange-600 dark:text-orange-400"
    },
    { 
      primary: "from-indigo-500 to-blue-500", 
      secondary: "from-indigo-50 to-blue-50 dark:from-indigo-950/20 dark:to-blue-950/20",
      accent: "text-indigo-600 dark:text-indigo-400"
    },
    { 
      primary: "from-teal-500 to-cyan-500", 
      secondary: "from-teal-50 to-cyan-50 dark:from-teal-950/20 dark:to-cyan-950/20",
...
export default function MonitoringSolutionsSection({
  ...
  return (
    <section className={`py-12 sm:py-16 bg-background relative overflow-hidden ${className}`}>
            ...
            return (
              <AnimatedDiv key={category} delay={categoryIndex * 0.1}>
                <div className="relative">
                  {/* Category Banner */}
                  <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-r ${theme.primary} p-6 mb-6 shadow-lg`}>
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-white/80 text-sm">
                            {categorySolutions.length} Solution{categorySolutions.length !== 1 ? 's' : ''} Available
                          </p>
                        </div>
                      </div>
                  ...
                  <div className={`grid gap-4 ${
                    ...
                    {categorySolutions.map((solution, index) => (
                      <AnimatedDiv key={solution.name} delay={categoryIndex * 0.1 + index * 0.05}>
                        <Card className={`group h-full border-0 shadow-md hover:shadow-xl transition-all duration-300 bg-gradient-to-br ${solution.bgGradient} hover:-translate-y-1 flex flex-col relative overflow-hidden`}>
                          {/* Hover overlay */}
                          <div className={`absolute inset-0 bg-gradient-to-br ${theme.secondary} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
