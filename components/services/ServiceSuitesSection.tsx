...
const defaultServiceCategories: ServiceCategory[] = [
  {
    ...
    description:
      "Comprehensive identity verification and security architecture that secures every access point with continuous authentication and micro-segmentation.",
  ...
  },
  {
    ...
    description:
      "Transform your business with intelligent automation, cloud modernization, and digital-first strategies that drive efficiency and innovation.",
  ...
  },
  {
    ...
    description:
      "Cutting-edge, customized IT infrastructure solutions built around your needs with secure architecture and intelligent monitoring.",
  ...
  },
  {
    ...
    description:
      "Deep technical expertise and project execution excellence with strategic consulting and comprehensive managed services support.",
            ...
            <AnimatedDiv key={category.name} delay={index * 0.2}>
              <Card className="group h-full border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm hover:-translate-y-3 relative overflow-hidden">
                ...
                <CardHeader className="text-center space-y-6 pb-8 relative z-10">
                  {/* Service Icon */}
                  <div
                    className={`inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-r ${category.gradient} text-white shadow-xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 mx-auto`}
                  >
                    {category.icon}
                  </div>
                ...
                <CardContent className="space-y-8 relative z-10">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid gap-3">
                      {category.items.map((item) => (
                        <div
                          key={item}
                          className="flex items-start space-x-3 p-3 rounded-lg bg-gradient-to-r from-gray-50 to-primary/5 dark:from-gray-800/50 dark:to-primary/5 transition-all duration-300 hover:scale-105 group-hover:bg-white/50"
                        >
                  ...
                  <div className="pt-6 text-center">
                    <Button
                      asChild
                      className={`bg-gradient-to-r ${category.gradient} hover:opacity-90 shadow-lg hover:shadow-xl transition-all duration-300 px-8 py-3 text-lg font-semibold group-hover:scale-105`}
                    >
