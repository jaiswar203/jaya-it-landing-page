...
const strategicPartners = [
  ...
  { id: 2, name: "Amazon Web Services", logo: "/partners/strategic/page10_img25.png" },
...
export default function ClientsPartnersPage() {
  const [clientsSwiperInstance, setClientsSwiperInstance] = useState<SwiperType | null>(null)
  const [partnersSwiperInstance, setPartnersSwiperInstance] = useState<SwiperType | null>(null)
          ...
          <div className="text-center mb-20">
            <AnimatedDiv>
              <div className="inline-flex items-center space-x-2 bg-primary/10 px-6 py-3 rounded-full mb-8 border border-primary/20">
                ...
                <span className="text-sm font-semibold text-primary uppercase tracking-wider">Clients & Partners</span>
              </div>
              ...
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Building strong relationships based on trust, collaboration, and mutual success with industry leaders across diverse sectors and innovative technology partners worldwide.
              </p>
            </AnimatedDiv>
          </div>

          {/* Overview Stats */}
          <AnimatedDiv className="grid grid-cols-2 lg:grid-cols-4 gap-6" delay={0.2}>
            {[
              { icon: <Building2 className="h-6 w-6" />, value: "16+", label: "Valued Clients", color: "from-blue-500 to-cyan-500" },
              { icon: <Globe className="h-6 w-6" />, value: "12+", label: "Tech Partners", color: "from-green-500 to-emerald-500" },
              { icon: <TrendingUp className="h-6 w-6" />, value: "15+", label: "Industries", color: "from-purple-500 to-violet-500" },
              { icon: <Award className="h-6 w-6" />, value: "500+", label: "Projects", color: "from-orange-500 to-red-500" }
            ].map((stat, index) => (
        ...
        <div className="container mx-auto px-4 md:px-6 relative">
          <div className="text-center mb-20">
            <AnimatedDiv>
              ...
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                We've had the privilege of partnering with diverse organizations across multiple industries, delivering exceptional IT solutions and building lasting relationships built on trust and excellence.
              </p>
            </AnimatedDiv>
          </div>

          {/* Client Stats Grid */}
          <AnimatedDiv className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-20" delay={0.2}>
              ...
              <AnimatedDiv key={stat.label} delay={0.3 + index * 0.1}>
                <Card className="group h-full border-0 shadow-lg hover:shadow-2xl transition-all duration-500 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm hover:-translate-y-2 hover:rotate-1 overflow-hidden relative">
                  ...
                  <CardContent className="p-8 text-center relative z-10">
                    <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r ${stat.color} mb-4 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-lg`}>
          ...
          <AnimatedDiv delay={0.5}>
            <Card className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border-0 shadow-2xl p-8 rounded-3xl">
              ...
              <div className="relative overflow-hidden rounded-xl bg-gray-50/50 dark:bg-gray-800/50 p-6">
                <Swiper
                  onSwiper={setClientsSwiperInstance}
                  modules={[Autoplay]}
                  spaceBetween={40}
                  slidesPerView={2}
                  autoplay={{
        ...
        <div className="container mx-auto px-4 md:px-6 relative">
          <div className="text-center mb-16">
            <AnimatedDiv>
              ...
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                We collaborate with industry-leading third-party service and tool providers to enhance the value we offer to our clients. Instead of building everything from scratch, we partner with trusted platforms and technologies, providing licenses and managed services so you can focus on your core business.
              </p>
            </AnimatedDiv>
          </div>
            ...
            <Card className="bg-gradient-to-br from-white/90 to-primary/5 dark:from-gray-900/90 dark:to-primary/10 border-0 shadow-2xl backdrop-blur-sm p-8 md:p-16 relative overflow-hidden">
              ...
              <CardContent className="relative z-10 text-center space-y-6">
                ...
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                  Partner with JAYAA IT Solution and leverage our extensive network of clients and technology partners to accelerate your digital transformation journey.
                </p>
