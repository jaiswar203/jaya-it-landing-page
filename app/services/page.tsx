          ...
          <div className="text-center">
            <AnimatedDiv>
              ...
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed mb-12">
                Empowering businesses with cutting-edge technology, robust security, and expert guidance. 
                Our comprehensive suite of services covers everything from zero trust security to digital transformation.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-12">
                <AnimatedDiv delay={0.2}>
                  <div className="flex items-center space-x-3 text-left">
                    ...
                    <div>
                      <h3 className="font-bold text-foreground">Advanced Security</h3>
                ...
                <AnimatedDiv delay={0.3}>
                  <div className="flex items-center space-x-3 text-left">
                    ...
                    <div>
                      <h3 className="font-bold text-foreground">Digital Innovation</h3>
                ...
                <AnimatedDiv delay={0.4}>
                  <div className="flex items-center space-x-3 text-left">
                    ...
                    <div>
                      <h3 className="font-bold text-foreground">Expert Support</h3>
                      <p className="text-sm text-muted-foreground">24/7 professional services</p>
                    </div>
                  </div>
                </AnimatedDiv>
              </div>
