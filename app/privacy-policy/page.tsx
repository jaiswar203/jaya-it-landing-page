  ...
  const sections = [
    {
      ...
      content: "Welcome to JAYAA IT Solution Pvt. Ltd. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at info@jayaaitsolution.com.",
              ...
              <CardContent className="relative z-10 text-center space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-center space-x-2 text-muted-foreground">
                    ...
                    <a href="mailto:info@jayaaitsolution.com" className="text-primary hover:text-secondary transition-colors font-semibold">
